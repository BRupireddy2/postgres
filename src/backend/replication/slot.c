		...
		case RS_INVAL_XID_AGE:
			{
				...
				{
					/*
					 * Both can be set for a logical slot that reserves the
 ...
 * differ from the persisted ones. A slot that reserves the data xmin to export
								  ...
								  bool slot_catalog_xmin_relevant)
{
	...
	/* Nothing to do if invalidation based on XID age is disabled */
